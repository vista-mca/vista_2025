...
import s5 from '../../assets/sponsors/s5.jpeg';
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 p-2 text-white'>
            <div className='-order-first md:order-first col-span-2 w-full flex items-center justify-center h-full mb-8'>
                <div className='text-center w-full md:w-2/3'>
                    <p className='text-2xl md:text-3xl font-semibold mb-3 md:mb-6'>Join Our Esteemed Sponsors</p>
                    <p className='text-lg md:text-xl italic mb-2 animation'>Be Recognized Among Industry Leaders at <span className='bg-gradient-to-r from-blue-500 to-blue-800 bg-clip-text text-transparent'>QalaInnoVista</span>.</p>
                    <p className='mb-4 animation'>Partner with us and showcase your brand alongside some of the most prestigious names in the industry. At QalaInnoVista, our sponsors play a pivotal role in making innovation and inspiration possible.</p>
